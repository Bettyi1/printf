...
/**
 * write_num - function writes a number using buffer
 * @buffer: buffer
 * @flags: flags
 * @ind: index
 * @width: width
...
/**
 * write_unsgnd - function prints unsigned num.
